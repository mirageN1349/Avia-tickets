...
class TicketsUI {
  ...
  static ticketTemplate(ticket, currency) {
    ...
    <div class="card ticket-card blue lighten-4">
      <div class="ticket-airline d-flex align-items-center justify-space-between">
        ...
        <a class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons" data-ticket-id="${ticket.data_ticket_id}">add</i></a>
      </div>
